...
class DeletingHabitWorker(
    ...
    override suspend fun doWork(): Result {
        try {
            ...
            val notification = NotificationCompat.Builder(context, DeletingHabitWorker.CHANNEL_ID)
                .setContentTitle("Habits")
                .setContentText("Habits deleting")
                .setSmallIcon(R.drawable.ic_launcher_foreground)
                .build()

            notificationManager.notify(DeletingHabitWorker.NOTIFICATION_ID, notification)
            ...
            notificationManager.cancel(DeletingHabitWorker.NOTIFICATION_ID)
        }
    }
    ...
    private fun createNotificationChannel(notificationManager: NotificationManager) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val notificationChannel = NotificationChannel(
                DeletingHabitWorker.CHANNEL_ID,
                DeletingHabitWorker.CHANNEL_NAME,
